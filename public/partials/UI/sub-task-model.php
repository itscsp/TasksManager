...
<div class="tasks-modal add-subtask-modal" id="add-subtask-modal-<?php echo $task_id; ?>" style="display:none;">
    <div class="tasks-modal-content">
        ...
        <h2 class="heading">Add Subtask</h2>
        
        <form class="subtask-form" data-task-id="<?php echo $task_id; ?>">
            <p>
                <label for="subtask_title_<?php echo $task_id; ?>">Title:</label>
                <input type="text" id="subtask_title_<?php echo $task_id; ?>" name="subtask_title" required>
            </p>
            <p>
                <label for="subtask_description_<?php echo $task_id; ?>">Description:</label>
                <textarea id="subtask_description_<?php echo $task_id; ?>" name="subtask_description" rows="4"></textarea>
            </p>
